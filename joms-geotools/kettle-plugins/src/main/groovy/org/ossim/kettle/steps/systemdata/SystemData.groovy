	...
	private Object[] getSystemData(RowMetaInterface inputRowMeta, Object[] inputRowData) throws KettleException
	{
		...
		{			
            ...
            case SystemDataMeta.TYPE_SYSTEM_INFO_FREE_SWAP_SPACE_SIZE:
                ...
                break;
            case SystemDataMeta.TYPE_SYSTEM_INFO_OS_NAME:
            	row[index] = Management.operatingSystemName
            	break
            case SystemDataMeta.TYPE_SYSTEM_INFO_OS_VERSION:
            	row[index] = Management.operatingSystemVersion
            	break
            case SystemDataMeta.TYPE_SYSTEM_INFO_OS_ARCH:
            	row[index] = Management.operatingSystemArch
            	break
