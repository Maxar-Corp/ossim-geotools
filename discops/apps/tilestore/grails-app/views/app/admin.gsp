        ...
        <div>
            <div class="col-md-2 image-card-thumb">
                <img data-toggle="tooltip" data-placement="bottom"
                     ...
                     src="http://10.0.10.180:9999/omar/thumbnail/show/{{properties.id}}" alt="Image thumbnail"
                     size="100">
            </div>
            <div class="col-md-8 image-card-info">
                ...
                <a href="http://10.0.10.180:9999/omar/mapView/imageSpace?layers={{properties.id}}"
