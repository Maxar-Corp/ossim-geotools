...
{
    //var url ='http://10.0.10.181:8080/tilestore/wfs?request=GetFeature&typeName=tilestore:layers'
    //var url = "../json_layer.txt"; // For testing while not on RBT network
    var wfsUrl;

    var tileUrls = [
        'http://s1:8080/tilestore/wms?',
        'http://s2:8080/tilestore/wms?',
        'http://s3:8080/tilestore/wms?',
        'http://s4:8080/tilestore/wms?'
    ];
    ...
    var reference = new ol.layer.Tile( {
        opacity: 1.0,
        source: new ol.source.TileWMS( {
            //url: 'http://10.0.10.181:8080/tilestore/wms?',
            urls: tileUrls,
    ...
    addRefTiles = function ()
    {
        ...
        addLayers = function ( id, name )
        {
            ...
            wmsUrl = 'http://10.0.10.181:8080/tilestore/wms?';
            //name = 'reference';
