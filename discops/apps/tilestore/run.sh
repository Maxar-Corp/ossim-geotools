...
export JAVA_OPTS="-server -Xms512m -Xmx2048m -Djava.awt.headless=true -XX:-UseGCOverheadLimit -XX:+UseConcMarkSweepGC -XX:+CMSIncrementalMode  -XX:MaxPermSize=512M"
export GRAILS_OPTS=$JAVA_OPTS
...
case "$3" in
true)
grails  -DhadoopDist=CDH5 ${mode} run-${style}  
;;
*)
