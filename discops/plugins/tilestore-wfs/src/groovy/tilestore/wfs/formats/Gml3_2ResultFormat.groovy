 ...
 */
class Gml3_2ResultFormat implements ResultFormat
{
  def name = "GML2"
...
//      xxx.each { println it }
        ...
        wfs.FeatureCollection(
          ...
          while ( cursor?.hasNext() )
          {
            ...
            if ( ! geomName )
            {
              geomName = feature.schema.geom.name
            }
                    ...
                    if ( attribute.key == geomName)
                    {
                      tilestore."${geomName}" {
                        ...
                        */
                        ...
                        def geom = new XmlSlurper( false, false ).parseText( feature[geomName].gml2 as String )
