...
{
   //private static final Class<?> packageName = CreateOvrHstMeta.class; // for i18n purposes, needed by Translator2!!   $NON-NLS-1$
   private static final String packageName = CreateOvrHstMeta.package.name; // for i18n purposes, needed by Translator2!!   $NON-NLS-1$
