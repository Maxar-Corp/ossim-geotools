...
@Step(
        ...
        image="org/ossim/kettle/steps/systemdata/icon.png",
        i18nPackageName="org.ossim.kettle.steps.systemdata"
) 
public class SystemDataMeta extends BaseStepMeta implements StepMetaInterface
{
   ...
   private static final String PKG = SystemDataMeta.package.name; // for i18n purposes, needed by Translator2!!   $NON-NLS-1$
    ...
    public final static int TYPE_SYSTEM_INFO_OS_NAME     =  96;
    public final static int TYPE_SYSTEM_INFO_OS_VERSION  =  97;
    public final static int TYPE_SYSTEM_INFO_OS_ARCH     =  98;

    public static def functions = [
            (SystemDataMetaFunction)null,
            ...
            new SystemDataMetaFunction(TYPE_SYSTEM_INFO_OS_NAME   , "OS name",    BaseMessages.getString(PKG, "SystemDataMeta.TypeDesc.OSName")), 
            new SystemDataMetaFunction(TYPE_SYSTEM_INFO_OS_VERSION   , "OS version", BaseMessages.getString(PKG, "SystemDataMeta.TypeDesc.OSVersion")), 
            new SystemDataMetaFunction(TYPE_SYSTEM_INFO_OS_ARCH   , "OS arch",    BaseMessages.getString(PKG, "SystemDataMeta.TypeDesc.OSArch")), 
    ] as SystemDataMetaFunction[]
	...
	public void getFields(RowMetaInterface row, String name, RowMetaInterface[] info, StepMeta nextStep, VariableSpace space) throws KettleStepException
	{
		for (int i=0;i<fieldName.length;i++)
		{
            ...
            case TYPE_SYSTEM_INFO_OS_NAME:
            case TYPE_SYSTEM_INFO_OS_VERSION:
            case TYPE_SYSTEM_INFO_OS_ARCH:
