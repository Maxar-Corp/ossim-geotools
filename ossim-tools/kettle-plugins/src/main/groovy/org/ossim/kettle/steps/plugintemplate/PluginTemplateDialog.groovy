 ...
 */
class PluginTemplateDialog extends BaseStepDialog implements
        StepDialogInterface
{
   private PluginTemplateMeta input
   private KettleSwtBuilder swt;

   public PluginTemplateDialog(Shell parent, Object baseStepMeta,
                          TransMeta transMeta, String stepname)
   {
      super(parent, (BaseStepMeta)baseStepMeta, transMeta, stepname);
      input = (PluginTemplateMeta)baseStepMeta;
   }
   public String open()
   {
      ...
      shell = swt.shell(parent) {
         ...
         group(id:"stepNameGroup") {
            ...
            label Messages.getString("PluginTemplateDialog.Stepname.Label")

            text(id: "stepName", layoutData: "span,growx", text: stepname) {
               onEvent(type: 'Modify') { input.setChanged() }
            }
            label Messages.getString("PluginTemplateDialog.ExampleTemplateFieldName.Label")
            ...
            group(layoutData: "grow, span, wrap") {
               ...
               button(id: "okButton", Messages.getString("PluginTemplateDialog.ok.Label"),
                       layoutData: "align center,split 2") {
                  onEvent(type: "Selection") { ok() }
               }
               button(id: "cancelButton", Messages.getString("PluginTemplateDialog.cancel.Label"), layoutData: "") {
      ...
      //setModalDialog(true)
      shell.text = Messages.getString("PluginTemplateDialog.Shell.Title")
