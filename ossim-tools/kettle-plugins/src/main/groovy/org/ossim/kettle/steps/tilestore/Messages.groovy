...
import org.ossim.kettle.steps.tilestore.TileStoreWriterMeta
import org.pentaho.di.i18n.BaseMessages

public class Messages
{
   private static final String packageName = TileStoreWriterMeta.package.name; // for i18n purposes, needed by Translator2!!   $NON-NLS-1$
